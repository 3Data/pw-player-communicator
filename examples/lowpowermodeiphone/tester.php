...
<html>
  ...
  <body>
    ...
    <div>Video status: <span id="videoStatus"></span><button style="visibility:hidden" id="btPlayVideo">Try play video</button></div>
    <div id="iframes-container">
      <iframe name="video-frame" src="<?php echo $iframe->urlVideo; ?>" style="width:100%; height:400px;"  allow="camera;microphone"></iframe>
